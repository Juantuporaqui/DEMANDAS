export const prescripcionPicassent = {
  ...
  planB: {
    title: 'Plan B — Anti-STS 458/2025 (límites y distinguishing)',
    enfoque:
      'Enfoque correcto: no discutir “la sentencia”; discutir alcance + encaje fáctico + heterogeneidad + motivación + prueba.',
    frasesTitle: 'Frases-núcleo (copia/pega mental):',
    frases: [
      '“STS 458/2025 no sustituye la prueba ni permite mezclar acciones heterogéneas.”',
      '“Si se aplica, debe ser por bloques homogéneos y con dies a quo motivado por bloque.”',
      '“No procede reactivar un paquete sin tabla verificable ni punto de corte cierto.”',
    ],
    filtrosTitle: 'Filtros que cortan la extensión automática:',
    filtros: [
      'Heterogeneidad: cuotas ≠ gastos ≠ inversiones',
      'Cronología remota / pre-matrimonio: no arrastre global',
      'Patrimonial/inversión: exige base propia, no etiqueta genérica',
      'Punto de corte: si dies a quo “al final”, fecha/hechos ciertos (no ruptura difusa)',
      'Interrupción: si la alegan, acto concreto y documentado (no genérico)',
    ],
  },
  guion: {
