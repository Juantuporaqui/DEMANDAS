...
function cleanText(input: string) {
  const replacements: Array<[string, string]> = [
    ...
    ['STS 19/12/2006', 'NO CONSTA: cita verificada'],
    ['STS de 19/12/2006', 'NO CONSTA: cita verificada'],
    [
      '2.3 — IMPUGNACIÓN DOCUMENTAL SELECTIVA',
      '2.2 BIS — PLUSPETICIÓN / DOBLE IMPUTACIÓN: HIPOTECA LOPE DE VEGA\n\n"Esta parte denuncia pluspetición por doble cómputo en la hipoteca de Lope de Vega: se reclaman cuotas y, además, el 50% del capital cancelado del préstamo previo, con potencial solapamiento cuantitativo. Se interesa: (a) desglose cuota a cuota (principal/intereses); (b) exclusión expresa de solapamientos; y (c) constancia en acta con soporte de carga probatoria y determinación conforme a LEC 217, LEC 219 y CE 24."\n\n2.3 — IMPUGNACIÓN DOCUMENTAL SELECTIVA',
    ],
    [
