...
export default function Topbar({ title = 'Case Ops', subtitle = 'Legal-tech workspace', actions }: TopbarProps) {
  return (
    <header className="sticky top-0 z-20 border-b border-[var(--border)] bg-[color-mix(in srgb, var(--surface) 85%, transparent)] backdrop-blur">
      <div
      ...
      >
        <div>
          ...
          <div className={`text-[11px] uppercase tracking-[0.25em] ${textMuted}`}>
            {subtitle}
          </div>
        </div>
