// Desglose de Hechos Reclamados - Picassent P.O. 715/2024
...
export interface HechoReclamado {
  ...
  oposicion: string[];
  estrategia: string;
  estado: 'prescrito' | 'compensable' | 'disputa';
  documentosRef: string[];
  tareas: string[];
  vinculadoA?: number; // ID de otro hecho relacionado
  año: number;
}
